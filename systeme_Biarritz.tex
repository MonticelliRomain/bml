...
1NT-2C
2D Pas de majeure 4e
2H Misère dorée : 8-9H et 5\h\ 
2S Misère dorée : 8-9H et 5\s\ 
2N 8-9HL, NF
3CD 5\c \emph{\d , FM, problème pour 3SA ou TDC
3H 5\s }4\h , FM
3H 5\h /4\s , FM
...
\subsection{1NT-2C : Texas \pdfc\ ou 8-9H régulier}

\begin{bidtable}
1NT-2\s\+\\
2NT \> mini\+\\
passe \> : 8-9H réguliers\\
3\c \> SO\\
3\d \> 5/5 mineur FM\\
3\h \> singleton \h \\
3\s \> singleton \s \\
