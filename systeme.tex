...
3\h \> fit \h\ 4e (irrégulier) 16-19 S ; suite Mathé (?)\\
...
2\c \> Irrégulier (5)6+\c , fit \h\ 3e, 14-14, NF\\
...
* Au niveau de 2 : Naturelle, limite
* Une couleur au niveau de 3 : Naturelle, FM+
* Répétition de la 4e couleur : Artificielle
...
5!h \> régulier, quantitatif et NF\-\-\\
2\d \> Transfert pour 2\h \+\\
2\h\+\\
Pass \> 5\h , 7-9H\\
2\s \> 5(+)\h -4+\s \\
2NT \> 5(+)\h -4+\c \\
...
4m \> unicolore \h\ 6e, court m, 16-18, 4 à 5 perdantes\-\-\\
...
3\d \> 4\h -5+\d , limite\\
3\s \> 1444 ou 0445, FM\\
4m \> 4\h -6+m, 17+ (couleur m au moins semi-solide; par opposition, 3m sur 1NT\+\\
puis \> 4m mettrait + l'accent sur le besoin d'un complément m chez l'ouvreur)\-\-\\
3\c \> Maxi\+\\
3\d \> 4\h -5\d , limite\\
3\h \> 4\h -5+\c , limite\\
3\s \> 1444 ou 0445, FM\\
4m \> 4\h -6+m, 17+ (couleur au moin semi-solide)\-\-\\
2NT \> Relais pour 3\c \+\\
3\c\+\\
Pass \> Sign off \c \\
3\d \> Limite 4\h -6\d \-\-\\
...
\subsubsection{La séquence 1\pdfc\ - 1\pdfd\ - 2\pdfc\ - 2\pdfd}
...
\item La réponse de 2SA au ``fit'' préférentiel à 2M de l'ouvreur est un Relais FM,n suite naturelle

\item Une nouvelle couleur est naturelle FM

\end{itemize}

\subsubsection{La séquence 1\pdfc\ - 1\pdfd\ - 3\pdfh}
...
Sur 1\c -1\h , le relais est à 3NT.

\subsection{La séquence 1\pdfc\ - 1\pdfh}
...
3\h \> Bicolore majeur 5-5 FM (voir avec ouverture 2\d\ ?)\-\\
2\d\h \> Inversée nat\+\\
2\s \> F1\\
2M' \> modérateur (?)/4e CF\\
...
3\s \> Fit \s\ 6e, FM 16+ sans courte (ou forcing chelem avec courte)\\
4\c\d\h \> Unicolore \s\ 6e court \c /\d /\h , 13-15, 5 à 6 perdantes\-
\end{bidtable}

\subsubsection{La séquence 1\pdfc\ - 1\pdfh\ - 1\pdfs\ - 2\pdfc}
...
\subsubsection{La séquence 1\pdfc\ - 1\pdfh\ - 1\pdfs\ - 2\pdfh}

\begin{bidtable}
1\c-1\h-1\s-2\h \> 5\s , 7-9H ou 5+\h\ irrégulier FM\+\\
...
2\h \> 5\s -4\h , 10-11\\
2\s \> 5\s , 10-11\\
2NT \> 5 très beaux \s\ (au moins 2GH+V10) régulier, choix de manche en face de xx\\
3m \> 5\s -5m, 9-10\\
3\h \> 5\s -5\h , 9-10\\
...
\subsection{La séquence 1\pdfc\ - 1\pdfs}
...
\subsection{La séquence 1\pdfc\ - 2\pdfc}
...
\subsection{La séquence 1\pdfc\ - 2\pdfd}
...
\subsection{La séquence 1\pdfc\ - 2\pdfh}
...
\subsection{La séquence 1\pdfc\ - 2\pdfs}
...
\subsection{La séquence 1\pdfc\ - 2NT}
