...
4\h \> Acol \h \\
4\s \> Acol \h\ (cue-bid)\-\\
3\c/3\d/3\c \> Texas \d , \h\ et \c \+\\
Ce \> sont des enchères positives en Texas mais pas nécessairent FM. L'ouvreur se décrit naturellement en privilégiant le fit. La rectification est négative.\-\\
...
4\h \> !! Pour jouer en face d'un 2 Fort ou 4P en face du 2 faible.\\
4\s \> Pour jouer en face d'un 2 faible ou au moins 5C en face d'un jeu fort\-
\end{bidtable}
